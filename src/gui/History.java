...
public class History extends javax.swing.JFrame {
     ...
     */
    public History() {
        username = Login.usernameTxt.getText();
        initComponents();
        this.setLocationRelativeTo(null); // center form in the screen
        this.setResizable(false); // prevent frame from being resized
        Databases databases = new Databases();
        databases.showHistory(username, this);
    }
    
    public void setTable(ArrayList<Integer> id, ArrayList<String> jenis, ArrayList<String> model, ArrayList<String> ukuran, ArrayList<Integer> harga) {
        ...
        for(int i = 0; i < jenis.size(); i++) {
            Object[] row = {
            id.get(i), jenis.get(i), model.get(i), ukuran.get(i), harga.get(i)
            };
            table.addRow(row);
        }
        historyTable.setModel(table);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(deleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 420, 150, 50));
        ...
        getContentPane().add(resetBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 430, 150, 40));
        ...
        getContentPane().add(JScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, 390, 230));
        ...
        panel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/History.png"))); // NOI18N
    ...
    private void minimizeBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeBtnMouseClicked
        this.setExtendedState(History.ICONIFIED);
    ...
    private void deleteBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBtnMouseClicked
        ...
        if(selectedRows.length == 1) {
            ...
            table.removeRow(historyTable.getSelectedRow());
            databases.delnRecord(selected);
    ...
    private void resetBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resetBtnMouseClicked
        int clear = table.getRowCount();
        Databases databases = new Databases();
        for(int i = clear - 1; i >= 0; i--) {
            table.removeRow(i);
        }
        databases.resetHistory();
